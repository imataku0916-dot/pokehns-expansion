...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    [MAPSEC_VIOLET_CITY]       = { 7,  5,  1, 1, COMPOUND_STRING("{JPN}キキョウシティ") },
    [MAPSEC_AZALEA_TOWN]       = { 6,  12, 1, 1, COMPOUND_STRING("{JPN}ヒワダタウン") },
    [MAPSEC_GOLDENROD_CITY]    = { 5,  7,  1, 2, COMPOUND_STRING("{JPN}コガネシティ") },
    [MAPSEC_ECRUTEAK_CITY]     = { 6,  3,  1, 1, COMPOUND_STRING("{JPN}エンジュシティ") },
    [MAPSEC_OLIVINE_CITY]      = { 3,  6,  1, 1, COMPOUND_STRING("{JPN}アサギシティ") },
    [MAPSEC_CIANWOOD_CITY]     = { 1,  9,  1, 1, COMPOUND_STRING("{JPN}タンバシティ") },
    [MAPSEC_SAFARI_ZONE_GATE]  = { 0,  7,  1, 1, COMPOUND_STRING("{JPN}サファリゾーンゲート") },
    [MAPSEC_MAHOGANY_TOWN]     = { 9,  3,  1, 1, COMPOUND_STRING("{JPN}チョウジタウン") },
    [MAPSEC_BLACKTHORN_CITY]   = { 12, 3,  1, 1, COMPOUND_STRING("{JPN}フスベシティ") },
    [MAPSEC_CHERRYGROVE_CITY]  = { 9,  11, 1, 1, COMPOUND_STRING("{JPN}ヨシノシティ") },
    [MAPSEC_NEW_BARK_TOWN]     = { 13, 11, 1, 1, COMPOUND_STRING("{JPN}ワカバタウン") },
    [MAPSEC_INDIGO_PLATEAU]    = { 16, 2,  1, 2, COMPOUND_STRING("{JPN}セキエイこうげん") },
    [MAPSEC_BATTLE_FRONTIER]   = { 12, 14, 1, 1, COMPOUND_STRING("{JPN}バトルフロンティア") },
    [MAPSEC_ROUTE_26]          = { 16, 8,  1, 4, COMPOUND_STRING("{JPN}26ばんどうろ") },
    [MAPSEC_ROUTE_27]          = { 14, 11, 3, 1, COMPOUND_STRING("{JPN}27ばんどうろ") },
    [MAPSEC_ROUTE_28]          = { 15, 7,  1, 1, COMPOUND_STRING("{JPN}28ばんどうろ") },
    [MAPSEC_ROUTE_29]          = { 10, 11, 3, 1, COMPOUND_STRING("{JPN}29ばんどうろ") },
    [MAPSEC_ROUTE_30]          = { 9,  6,  1, 5, COMPOUND_STRING("{JPN}30ばんどうろ") },
    [MAPSEC_ROUTE_31]          = { 8,  5,  2, 1, COMPOUND_STRING("{JPN}31ばんどうろ") },
    [MAPSEC_ROUTE_32]          = { 7,  6,  1, 5, COMPOUND_STRING("{JPN}32ばんどうろ") },
    [MAPSEC_ROUTE_33]          = { 7,  12, 1, 1, COMPOUND_STRING("{JPN}33ばんどうろ") },
    [MAPSEC_ROUTE_34]          = { 5,  9,  1, 2, COMPOUND_STRING("{JPN}34ばんどうろ") },
    [MAPSEC_ROUTE_35]          = { 5,  6,  1, 1, COMPOUND_STRING("{JPN}35ばんどうろ") },
    [MAPSEC_ROUTE_36]          = { 6,  5,  1, 1, COMPOUND_STRING("{JPN}36ばんどうろ") },
    [MAPSEC_ROUTE_37]          = { 6,  4,  1, 1, COMPOUND_STRING("{JPN}37ばんどうろ") },
    [MAPSEC_ROUTE_38]          = { 4,  3,  2, 1, COMPOUND_STRING("{JPN}38ばんどうろ") },
    [MAPSEC_ROUTE_39]          = { 3,  3,  1, 3, COMPOUND_STRING("{JPN}39ばんどうろ") },
    [MAPSEC_ROUTE_40]          = { 2,  6,  1, 3, COMPOUND_STRING("{JPN}40ばんすいどう") },
    [MAPSEC_ROUTE_41]          = { 2,  9,  1, 1, COMPOUND_STRING("{JPN}41ばんすいどう") },
    [MAPSEC_ROUTE_42]          = { 7,  3,  2, 1, COMPOUND_STRING("{JPN}42ばんどうろ") },
    [MAPSEC_ROUTE_43]          = { 9,  2,  1, 1, COMPOUND_STRING("{JPN}43ばんどうろ") },
    [MAPSEC_ROUTE_44]          = { 10, 3,  2, 1, COMPOUND_STRING("{JPN}44ばんどうろ") },
    [MAPSEC_ROUTE_45]          = { 12, 4,  1, 5, COMPOUND_STRING("{JPN}45ばんどうろ") },
    [MAPSEC_ROUTE_46]          = { 11, 8,  1, 3, COMPOUND_STRING("{JPN}46ばんどうろ") },
    [MAPSEC_ROUTE_47]          = { 0,  9,  1, 1, COMPOUND_STRING("{JPN}47ばんどうろ") },
    [MAPSEC_ROUTE_48]          = { 0,  8,  1, 1, COMPOUND_STRING("{JPN}48ばんどうろ") },
    [MAPSEC_SAFARI_ZONE]       = { 0,  6,  1, 1, COMPOUND_STRING("{JPN}サファリゾーン") },
    [MAPSEC_VICTORY_ROAD_HNS]  = { 16, 4,  1, 4, COMPOUND_STRING("{JPN}チャンピオンロード") },
    [MAPSEC_PALLET_TOWN]       = { 19, 11, 1, 1, COMPOUND_STRING("{JPN}マサラタウン") },
    [MAPSEC_VIRIDIAN_CITY]     = { 19, 7,  1, 1, COMPOUND_STRING("{JPN}トキワシティ") },
    [MAPSEC_PEWTER_CITY]       = { 19, 2,  1, 1, COMPOUND_STRING("{JPN}ニビシティ") },
    [MAPSEC_CERULEAN_CITY]     = { 24, 2,  1, 1, COMPOUND_STRING("{JPN}ハナダシティ") },
    [MAPSEC_LAVENDER_TOWN]     = { 27, 5,  1, 1, COMPOUND_STRING("{JPN}シオンタウン") },
    [MAPSEC_VERMILION_CITY]    = { 24, 7,  1, 1, COMPOUND_STRING("{JPN}クチバシティ") },
    [MAPSEC_CELADON_CITY]      = { 22, 5,  1, 1, COMPOUND_STRING("{JPN}タマムシシティ") },
    [MAPSEC_FUCHSIA_CITY]      = { 24, 11, 1, 1, COMPOUND_STRING("{JPN}セキチクシティ") },
    [MAPSEC_SOUTHERN_ISLAND]   = { 9,  14, 1, 1, COMPOUND_STRING("{JPN}みなみのことう") },
    [MAPSEC_FARAWAY_ISLAND]    = { 9,  14, 1, 1, COMPOUND_STRING("{JPN}さいはてのことう") },
    [MAPSEC_BIRTH_ISLAND]      = { 9,  14, 1, 1, COMPOUND_STRING("{JPN}たんじょうのしま") },
    [MAPSEC_CINNABAR_ISLAND]   = { 19, 13, 1, 1, COMPOUND_STRING("{JPN}グレンじま") },
    [MAPSEC_SAFFRON_CITY]      = { 24, 5,  1, 1, COMPOUND_STRING("{JPN}ヤマブキシティ") },
    [MAPSEC_ROUTE_1]           = { 19, 8,  1, 3, COMPOUND_STRING("{JPN}1ばんどうろ") },
    [MAPSEC_ROUTE_2]           = { 19, 3,  1, 4, COMPOUND_STRING("{JPN}2ばんどうろ") },
    [MAPSEC_ROUTE_3]           = { 20, 2,  2, 1, COMPOUND_STRING("{JPN}3ばんどうろ") },
    [MAPSEC_ROUTE_4]           = { 21, 2,  1, 1, COMPOUND_STRING("{JPN}4ばんどうろ") },
    [MAPSEC_ROUTE_5]           = { 24, 3,  1, 2, COMPOUND_STRING("{JPN}5ばんどうろ") },
    [MAPSEC_ROUTE_6]           = { 24, 6,  1, 1, COMPOUND_STRING("{JPN}6ばんどうろ") },
    [MAPSEC_ROUTE_7]           = { 23, 5,  1, 1, COMPOUND_STRING("{JPN}7ばんどうろ") },
    [MAPSEC_ROUTE_8]           = { 25, 5,  2, 1, COMPOUND_STRING("{JPN}8ばんどうろ") },
    [MAPSEC_ROUTE_9]           = { 25, 2,  3, 1, COMPOUND_STRING("{JPN}9ばんどうろ") },
    [MAPSEC_ROUTE_10]          = { 27, 3,  1, 1, COMPOUND_STRING("{JPN}10ばんどうろ") },
    [MAPSEC_ROUTE_11]          = { 25, 7,  2, 1, COMPOUND_STRING("{JPN}11ばんどうろ") },
    [MAPSEC_ROUTE_12]          = { 27, 6,  1, 4, COMPOUND_STRING("{JPN}12ばんどうろ") },
    [MAPSEC_ROUTE_13]          = { 26, 10, 2, 1, COMPOUND_STRING("{JPN}13ばんどうろ") },
    [MAPSEC_ROUTE_14]          = { 26, 11, 1, 1, COMPOUND_STRING("{JPN}14ばんどうろ") },
    [MAPSEC_ROUTE_15]          = { 25, 11, 1, 1, COMPOUND_STRING("{JPN}15ばんどうろ") },
    [MAPSEC_ROUTE_16]          = { 21, 5,  1, 1, COMPOUND_STRING("{JPN}16ばんどうろ") },
    [MAPSEC_ROUTE_17]          = { 21, 6,  1, 6, COMPOUND_STRING("{JPN}17ばんどうろ") },
    [MAPSEC_ROUTE_18]          = { 22, 11, 2, 1, COMPOUND_STRING("{JPN}18ばんどうろ") },
    [MAPSEC_ROUTE_19]          = { 22, 12, 3, 2, COMPOUND_STRING("{JPN}19ばんすいどう") },
    [MAPSEC_ROUTE_20]          = { 20, 13, 2, 1, COMPOUND_STRING("{JPN}20ばんすいどう") },
    [MAPSEC_ROUTE_21]          = { 19, 12, 1, 1, COMPOUND_STRING("{JPN}21ばんすいどう") },
    [MAPSEC_ROUTE_22]          = { 17, 7,  2, 1, COMPOUND_STRING("{JPN}22ばんどうろ") },
    [MAPSEC_ROUTE_24]          = { 24, 0,  1, 2, COMPOUND_STRING("{JPN}24ばんどうろ") },
    [MAPSEC_ROUTE_25]          = { 25, 0,  1, 1, COMPOUND_STRING("{JPN}25ばんどうろ") },
    [MAPSEC_VIRIDIAN_FOREST]   = { 19, 4,  1, 2, COMPOUND_STRING("{JPN}トキワのもり") },
    [MAPSEC_MT_MOON]           = { 22, 2,  1, 1, COMPOUND_STRING("{JPN}おつきみやま") },
    [MAPSEC_DIGLETTS_CAVE]     = { 20, 3,  6, 4, COMPOUND_STRING("{JPN}ディグダのあな") },
    [MAPSEC_ROCKET_HIDEOUT_HNS] = { 9,  3,  1, 1, COMPOUND_STRING("{JPN}ロケットだんアジト") },
    [MAPSEC_ROCK_TUNNEL]       = { 27, 3,  1, 1, COMPOUND_STRING("{JPN}イワヤマトンネル") },
    [MAPSEC_SEAFOAM_ISLANDS]   = { 22, 13, 1, 1, COMPOUND_STRING("{JPN}ふたごじま") },
    [MAPSEC_CERULEAN_CAVE]     = { 23, 1,  1, 1, COMPOUND_STRING("{JPN}ハナダのどうくつ") },
    [MAPSEC_POWER_PLANT]       = { 27, 3,  1, 1, COMPOUND_STRING("{JPN}はつでんしょ") },
    [MAPSEC_DARK_CAVE]         = { 10, 5,  1, 1, COMPOUND_STRING("{JPN}くらやみのほらあな") },
    [MAPSEC_UNION_CAVE]        = { 7,  11, 1, 2, COMPOUND_STRING("{JPN}つながりのどうくつ") },
    [MAPSEC_ILEX_FOREST]       = { 5,  11, 1, 2, COMPOUND_STRING("{JPN}ウバメのもり") },
    [MAPSEC_NATIONAL_PARK]     = { 5,  5,  1, 1, COMPOUND_STRING("{JPN}しぜんこうえん") },
    [MAPSEC_WHIRL_ISLANDS]     = { 2,  9,  1, 1, COMPOUND_STRING("{JPN}うずまきじま") },
    [MAPSEC_CLIFF_CAVE]        = { 0,  9,  1, 1, COMPOUND_STRING("{JPN}だんがいのどうくつ") },
    [MAPSEC_MT_MORTAR]         = { 10, 3,  1, 1, COMPOUND_STRING("{JPN}スリバチやま") },
    [MAPSEC_LAKE_OF_RAGE]      = { 9,  1,  1, 1, COMPOUND_STRING("{JPN}いかりのみずうみ") },
    [MAPSEC_ICE_PATH]          = { 11, 2,  2, 1, COMPOUND_STRING("{JPN}こおりのぬけみち") },
    [MAPSEC_MT_SILVER]         = { 14, 7,  1, 1, COMPOUND_STRING("{JPN}シロガネやま") },
    [MAPSEC_SNOWSWEPT_CAVERN]  = { 14, 6,  1, 1, COMPOUND_STRING("{JPN}ふぶきのどうくつ") },
    [MAPSEC_ROUTE_49]          = { 14, 6,  1, 1, COMPOUND_STRING("{JPN}49ばんどうろ") },
    [MAPSEC_NEW_SINJOH]        = { 14, 5,  1, 1, COMPOUND_STRING("{JPN}ニューシント") },
    [MAPSEC_ROUTE_50]          = { 14, 4,  1, 1, COMPOUND_STRING("{JPN}50ばんどうろ") },
    [MAPSEC_SINJOH_RUINS]      = { 14, 3,  1, 1, COMPOUND_STRING("{JPN}シントいせき") },
    [MAPSEC_TOHJO_FALLS]       = { 14, 10, 1, 1, COMPOUND_STRING("{JPN}トージョウのたき") },
    [MAPSEC_SPROUT_TOWER]      = { 7,  5,  1, 1, COMPOUND_STRING("{JPN}マダツボミのとう") },
    [MAPSEC_SLOWPOKE_WELL]     = { 6,  12, 1, 1, COMPOUND_STRING("{JPN}ヤドンのいど") },
    [MAPSEC_BURNED_TOWER]      = { 6,  3,  1, 1, COMPOUND_STRING("{JPN}やけたとう") },
    [MAPSEC_TIN_TOWER]         = { 6,  2,  1, 1, COMPOUND_STRING("{JPN}スズのとう") },
    [MAPSEC_DRAGONS_DEN]       = { 12, 2,  1, 1, COMPOUND_STRING("{JPN}りゅうのあな") },
    [MAPSEC_RUINS_OF_ALPH]     = { 6,  6,  1, 1, COMPOUND_STRING("{JPN}アルフのいせき") },
    [MAPSEC_SS_AQUA]           = { 9,  14, 10, 1, COMPOUND_STRING("{JPN}アクアごう") },
    [MAPSEC_EMBEDDED_TOWER]    = { 1,  10, 1, 1, COMPOUND_STRING("{JPN}うずもれのとう") },
    [MAPSEC_OLIVINE_LIGHTHOUSE] = { 3, 6,  1, 1, COMPOUND_STRING("{JPN}アサギのとうだい") },
    [MAPSEC_TRAINER_HILL]      = { 2,  5,  1, 1, COMPOUND_STRING("{JPN}トレーナーヒル") },
    [MAPSEC_MELEMELE_ISLAND]   = { 26, 13, 1, 1, COMPOUND_STRING("{JPN}メレメレじま") },
    [MAPSEC_AKALA_ISLAND]     = { 27, 12, 1, 1, COMPOUND_STRING("{JPN}アーカラじま") },
    [MAPSEC_ULAULA_ISLAND]    = { 27, 13, 1, 1, COMPOUND_STRING("{JPN}ウラウラじま") },
    [MAPSEC_PONI_ISLAND]      = { 25, 13, 1, 1, COMPOUND_STRING("{JPN}ポニじま") },
    [MAPSEC_ALOLA_OCEAN]      = { 25, 12, 1, 1, COMPOUND_STRING("{JPN}アローラかい") },
    [MAPSEC_AKALA_CAVE]       = { 27, 14, 1, 1, COMPOUND_STRING("{JPN}アーカラのどうくつ") },
    [MAPSEC_AKALA_FOREST]     = { 27, 11, 1, 1, COMPOUND_STRING("{JPN}アーカラのもり") },
    [MAPSEC_PONI_CAVE]        = { 25, 14, 1, 1, COMPOUND_STRING("{JPN}ポニのどうくつ") },
    [MAPSEC_ULAULA_CAVE]     = { 26, 14, 1, 1, COMPOUND_STRING("{JPN}ウラウラのどうくつ") },
    [MAPSEC_ULAULA_CAVE_2]   = { 26, 12, 1, 1, COMPOUND_STRING("{JPN}ウラウラのどうくつ") },
};
#endif
