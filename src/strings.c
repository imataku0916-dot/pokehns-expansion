...
const u8 gText_NextLv[] = _("{JPN}つぎのレベルまで");
...
const u8 gText_XNatureMetAtYZ[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}で であった。");
const u8 gText_XNatureHatchedAtYZ[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}で かえった。");
const u8 gText_XNatureObtainedInTrade[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\nつうしんこうかんで\nやってきた。");
const u8 gText_XNatureFatefulEncounter[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\nうんめいてきな であいをした。");
const u8 gText_XNatureProbablyMetAt[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}で であったようだ。");
const u8 gText_XNature[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく");
const u8 gText_XNatureMetSomewhereAt[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\nどこかで であった。");
const u8 gText_XNatureHatchedSomewhereAt[] = _("{JPN}{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\nどこかで かえった。");
