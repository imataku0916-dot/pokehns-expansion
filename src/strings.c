...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}で であった。");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}で かえった。");
const u8 gText_XNatureObtainedInTrade[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\nつうしんこうかんで\nやってきた。");
const u8 gText_XNatureFatefulEncounter[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\nうんめいてきな であいをした。");
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}で であったようだ。");
const u8 gText_XNature[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく");
const u8 gText_XNatureMetSomewhereAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\nどこかで であった。");
const u8 gText_XNatureHatchedSomewhereAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}{DYNAMIC 6}{DYNAMIC 7}な せいかく。\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}の とき\nどこかで かえった。");
